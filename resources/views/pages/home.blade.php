        ...
        <div class="card mt-3 bg-dark">
            <div class="card-header d-flex">
                ...
                <div class="row ms-auto">
                        <div class="search">
                            <div class="rounded-3" style="width:400px;">
                                <form action="{{ route('posts') }}" method="GET" role="search">
                                    <div class="input-group">
                                        <input type="text" class="form-control rounded-3" name="post" placeholder="Search posts" id="post">
                                        <a href="{{ route('posts') }}" class="">

                                            <span class="text-light"><span class="input-group-btn">
                                                <button class="btn bg-white" type="submit" title="Search Post">
                                ...
                                <div class="card-body bg-dark rounded text-light">
                                    <div class="container-fluid">
                                        <div class="navbar-brand d-flex" href="">
                                            <img class="card m-2" style="border-radius: 50%; width: 30px;" id="pfemale"
